...
WebUI.verifyElementText(findTestObject('Object Repository/pago/Page_Olva Courier  Datos Personales/div_El peso no puede exceder los 25 Kgs'), 
    'El peso no puede exceder los 25 Kgs.')
