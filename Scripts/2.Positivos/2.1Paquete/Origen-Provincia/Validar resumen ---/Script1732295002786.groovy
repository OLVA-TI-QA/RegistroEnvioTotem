...
WebUI.click(findTestObject('Object Repository/Principal/Page_Olva Courier  Datos Personales/button_Seleccionar artculo'))

WebUI.click(findTestObject('Object Repository/Principal/Page_Olva Courier  Datos Personales/a_CAJA'))

WebUI.setText(findTestObject('Object Repository/Principal/Page_Olva Courier  Datos Personales/input_UTILES DE OFICINA_txt_paquete_articulo'), 
    'FGDg')

WebUI.setText(findTestObject('Object Repository/Principal/Page_Olva Courier  Datos Personales/input_UTILES DE OFICINA_txt_paquete_valor'), 
    '50')

WebUI.click(findTestObject('Object Repository/Principal/Page_Olva Courier  Datos Personales/div_Hasta 2Kg'))
...
WebUI.scrollToElement(findTestObject('Object Repository/Principal/Page_Olva Courier  Datos Personales/button_Tipo De Documento_1'), 
    0)
