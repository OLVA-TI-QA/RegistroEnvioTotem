...
WebUI.scrollToElement(findTestObject('Object Repository/valorado/Page_Olva Courier  Datos Personales/button_Ingrese el punto de llegada (2)'), 
    0)
...
WebUI.verifyElementText(findTestObject('Object Repository/valorado/Page_Olva Courier  Confirma tus datos/div_He ledo la (1)'), 
    'He leído la', FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('Object Repository/valorado/Page_Olva Courier  Confirma tus datos/label_Declaro bajo juramento los productos _f4619d (1)'), 
    'Declaro bajo juramento los productos escritos en el registro de envíos.')
...
WebUI.click(findTestObject('Object Repository/valorado/Page_Olva Courier  Medios de pago/button_PAGAR (1)'), FailureHandling.STOP_ON_FAILURE)
