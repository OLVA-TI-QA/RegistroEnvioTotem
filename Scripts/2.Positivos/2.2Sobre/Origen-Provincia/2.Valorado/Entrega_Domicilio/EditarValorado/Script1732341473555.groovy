...
WebUI.click(findTestObject('Object Repository/valorado/Page_Olva Courier  Datos Personales/button_Recojo en tienda'))

WebUI.click(findTestObject('Object Repository/valorado/Page_Olva Courier  Datos Personales/a_Entrega a domicilio'))
